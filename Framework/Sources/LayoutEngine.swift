...
open class LayoutEngine {
  ...
  var mergedCellAddresses = Set<Address>()
  var mergedCellRects = [Address: CGRect]()
  
  var visibleCellAddresses = Set<Address>()
  
  var horizontalGridLayouts = [Address: GridLayout]()
  var verticalGridLayouts = [Address: GridLayout]()
  ...
  open func enumerateColumns(currentRow row: Int, currentRowIndex rowIndex: Int) -> Bool {
  ...
  open func layoutCell(address: Address, frame: CGRect) {
  ...
  func layoutGridlines(address: Address, frame: CGRect, gridlines: Gridlines) {
  ...
  open func renderHorizontalGridlines() {
  ...
  open func renderVerticalGridlines() {
  ...
  func extractGridStyle(style: GridStyle) -> (width: CGFloat, color: UIColor, priority: CGFloat) {
  ...
  open func returnReusableResouces() {
...
open class LayoutAttributes {
  ...
  init(startColumn: Int = 0, startRow: Int = 0,
       ...
       rowCount: Int = 0, insets: CGPoint = CGPoint(x: 0, y: 0)) {
